<script lang="ts">
	...
	import type { UserExternalProfileData } from '$lib/custom.types';
	...
	{#each communityWorkshopOptions as { value, lable }}
		<div class="flex items-center col-span-1">
			<input
				...
				type="checkbox"
				bind:group={communityExternalProfileData.community_workshop_choices}
				{value}
			/>
			<label
...
<TextAreaInput
	...
	bind:inputValue={communityExternalProfileData.other_community_workshop}
/>
<TextAreaInput
	headingClass="unstyled mb-1 text-xl font-semibold text-gray-900"
	...
	textAreaClass="w-full resize-y sm:text-lg"
	bind:inputValue={communityExternalProfileData.will_run_community_workshops}
/>
