...
<AppBar
	class="grid grid-cols-3 grid-flow-col gap-4"
	padding="1"
	background="bg-primary-400"
	slotLead="col-span-1"
	slotDefault="col-span-1 flex justify-center items-center"
	slotTrail="col-span-1 flex justify-end items-center"
>
	...
	<svelte:fragment slot="default">
		<a
			...
			href="/"
			class="btn bg-tertiary-400 btn-base mr-2 font-semibold invisible rounded-xl lg:visible"
			>Home</a
		>
		<a
		...
		<a
			...
			href="/contact"
			class="btn bg-tertiary-400 btn-base font-semibold invisible rounded-xl lg:visible"
			>Contact Us</a
		>
	</svelte:fragment>
