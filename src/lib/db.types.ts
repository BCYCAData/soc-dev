...
export type Database = {
	...
	public: {
		...
		Views: {
			_kyng_edge_classification: {
				Row: {
					along_cadastre_m: number | null;
					edge_len_m: number | null;
					kyng: string | null;
				};
				Relationships: [];
			};
			_kyng_snap_review_cases: {
				Row: {
					address: string | null;
					id: number | null;
					kyngs_touched: string[] | null;
					m2_per_kyng: number[] | null;
				};
				Relationships: [];
			};
		...
		Enums: {
			...
			field_type: 'text' | 'number' | 'date' | 'select' | 'boolean' | 'multiselect';
