...
export let getBCYCACommunityWorkshopsFormData = (body: FormData) => {
	const bcycaCommunityEventsData = {
...
export const getBCYCACommunityEventsFormData = (body: FormData) => {
	const bcycaCommunityEventsData = {
...
export const getBCYCACommunityInformationFormData = (body: FormData) => {
	const bcycaCommunityInformationData = {
...
export const getMyCommunityFormData = (body: FormData) => {
	...
	return { myCommunitysData, postalAddressData };
};

export const getMyPlaceResourcesFormData = (body: FormData) => {
	const myPlaceResourcesData = {
...
// 	const userBCYCAProfileData: CommunityBCYCAProfileData = {
// 		community_meeting_choices:
// 			body.getAll('community_meeting_choices').toString().split(',').map(Number) || null,
// 		community_workshop_choices:
// 			body.getAll('community_workshop_choices').toString().split(',').map(Number) || null,
...
// 		will_run_community_workshops: (body.get('will_run_community_workshops') as string) || null
// 	};
// 	const userTinoneeProfileData: CommunityTinoneeProfileData = {
// 		community_meeting_choices:
// 			body.getAll('community_meeting_choices').toString().split(',').map(Number) || null,
// 		community_workshop_choices:
// 			body.getAll('community_workshop_choices').toString().split(',').map(Number) || null,
...
// 		will_run_community_workshops: (body.get('will_run_community_workshops') as string) || null
// 	};
// 	const userMondrookProfileData: CommunityMondrookProfileData = {
// 		community_meeting_choices:
// 			body.getAll('community_meeting_choices').toString().split(',').map(Number) || null,
// 		community_workshop_choices:
// 			body.getAll('community_workshop_choices').toString().split(',').map(Number) || null,
...
// 		will_run_community_workshops: (body.get('will_run_community_workshops') as string) || null
// 	};
// 	const userExternalProfileData: CommunityExternalProfileData = {
// 		community_meeting_choices:
// 			body.getAll('community_meeting_choices').toString().split(',').map(Number) || null,
// 		community_workshop_choices:
// 			body.getAll('community_workshop_choices').toString().split(',').map(Number) || null,
