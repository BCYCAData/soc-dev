...
async function generateRfsStreetReport(streetname: string, propertyData: any): Promise<Blob> {
	...
	for (const item of propertyData) {
		...
		if (item.agentinformation) {
			body.push(
				[
					...
					{ text: 'Property is rented:', colSpan: 2, style: 'nameHeader2' },
					{},
					{ text: 'Agent', style: 'nameHeader2' },
					{ text: item.agentinformation.agentname, style: 'nameHeader2', alignment: 'left' }
				],
				[
					{ text: '', style: 'tableHeader' },
					{ text: '', colSpan: 2 },
					{},
					{ text: 'Mobile', style: 'nameHeader2' },
					{ text: item.agentinformation.agentmobile, style: 'nameHeader2', alignment: 'left' }
				],
				[
					{ text: '', style: 'tableHeader' },
					{ text: '', colSpan: 2 },
					{},
					{ text: 'Phone', style: 'nameHeader2' },
					{ text: item.agentinformation.agentphone, style: 'nameHeader2', alignment: 'left' }
				]
			);
		}
		body.push(
		...
		body.push([
			...
			{},
			{ text: '', colSpan: 2, style: 'tableHeader2' },
			{}
		]);
		for (const resident of item.residents) {
			body.push(
				[
					{ text: '', style: 'tableHeader2' },
