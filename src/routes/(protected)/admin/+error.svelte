...
<svelte:head>
	<title>403: Admin Access Required</title>
</svelte:head>

{#if page.status === 403}
	<Error403 message={page.error?.message || 'Admin access required'} context="admin" />
{:else}
	<!-- Fallback for other errors in admin section -->
