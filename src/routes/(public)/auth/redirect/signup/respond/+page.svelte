...
<section class="mx-auto mt-5 flex h-full max-w-3xl flex-col items-center text-center sm:mt-1">
	<h1 class="title-font text-secondary-600 hidden font-bold underline sm:block sm:text-2xl">
		Strengthen OUR Community
	</h1>
	{#if redirectType === 'signup'}
		<div class="bg-success-100 text-surface-900 mt-2 w-full items-center rounded-lg">
	...
	{:else if redirectType === 'emailExists'}
		<div class="bg-error-100 text-surface-900 mt-2 w-full items-center rounded-lg">
