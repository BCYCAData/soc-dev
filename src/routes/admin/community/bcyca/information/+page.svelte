		...
		<svelte:fragment slot="content">
			<div class="table-container" id="PreFireSeasonChecklist">
				<CommunityRequestsTable
					communityRequestsColumns={bcycaInformationColumns}
					communityRequestsData={bcycaInformationData.filter((item) =>
	...
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="OtherInformationRequests">
				<CommunityRequestsTable
					communityRequestsColumns={bcycaOtherInformationColumns}
					communityRequestsData={bcycaInformationData.filter(
