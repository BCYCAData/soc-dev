		...
		<svelte:fragment slot="content">
			<div class="table-container" id="CompletingFirePlan">
				<CommunityRequestsTable
					communityRequestsColumns={bcycaWorkshopsColumns}
					communityRequestsData={bcycaWorkshopsData.filter((item) =>
	...
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="OtherWorkshopSuggestions">
				<CommunityRequestsTable
					communityRequestsColumns={bcycaOtherWorkshopsColumns}
					communityRequestsData={bcycaWorkshopsData.filter(
	...
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="WillRunWorkshops">
				<CommunityRequestsTable
					communityRequestsColumns={bcycaWillRunWorkshopsColumns}
					communityRequestsData={bcycaWorkshopsData.filter(
