		...
		<svelte:fragment slot="content">
			<div class="table-container" id="CompletingFirePlan">
				<CommunityRequestsTable
					...
					tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(1))}
				/>
			</div>
		</svelte:fragment>
	</AccordionItem>
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="OnlineVideoCalls">
				<table class="table table-hover">
					<CommunityRequestsTable
						columns={externalWorkshopsColumns}
						tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(2))}
					/>
				</table>
			</div></svelte:fragment
		>
	...
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="EmergencyPackAndPlan">
				<CommunityRequestsTable
					columns={externalWorkshopsColumns}
					tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(3))}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="MakingFireTrailer">
				<CommunityRequestsTable
					columns={externalWorkshopsColumns}
					tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(4))}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="BushfireSafetyTraining">
				<CommunityRequestsTable
					columns={externalWorkshopsColumns}
					tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(5))}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
	<AccordionItem class="bg-orange-100 font-medium">
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="SmallPileBurn">
				<CommunityRequestsTable
					columns={externalWorkshopsColumns}
					tableData={externalWorkshopsData.filter((item) => item.workshop_choices?.includes(6))}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="OtherWorkshopSuggestions">
				<CommunityRequestsTable
					...
					tableData={externalWorkshopsData.filter((item) => item.other_wokshop?.length > 0)}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
		...
		<svelte:fragment slot="content">
			<div class="table-container" id="WillRunWorkshops">
				<CommunityRequestsTable
					...
					tableData={externalWorkshopsData.filter((item) => item.will_run_wokshop?.length > 0)}
				/>
			</div></svelte:fragment
		>
	</AccordionItem>
