...
<section class="flex flex-col mx-auto h-full max-w-3xl text-gray-900">
	...
	<br />
	<p class="m-1">
		Thanks for taking the time to read our Terms of Use regarding your use of the Strengthen Our
		Community website. These terms define your rights and responsibilities when using the website.
	</p>
	...
	<div class="mx-5">
		<p class="m-1">
			...
			means the information provided on the website, the collection and representation of the data you
			provide.
		</p>
		<p class="m-1">
			<strong>The Website</strong>
			means the website [insert website details]
		</p>
		<p class="m-1">
			<strong>We / Us etc</strong>
			means The Strengthen Our Community Project Team and Burrell Creek Youth and Community Association.
		</p>
		<p class="m-1">
			<strong>You</strong>
	...
	<p class="m-1">By using this Website, you are agreeing to these terms and conditions.</p>
	<p class="m-1">
		You provide data to this website with the knowledge that it will be made available to emergency
		services for the duration of an emergency situation.
	</p>
	<p class="m-1">
	...
	<p class="m-1">
		...
		Website for any purpose that is unlawful, defamatory, harassing, abusive, fraudulent or obscene
		or in any other inappropriate way or in a way which conflicts with the Website or the Services.
	</p>
	<p class="m-1">
	...
	<p class="m-1">
		You agree to indemnify Us and hold Us harmless from and against any and all liabilities or
		expenses arising from or in any way related to your use of this Website or information offered
		on this Website, including any liability or expense arising from all claims, losses, damages
	...
	<p class="m-1">
		We hold the intellectual property rights and copyright to the content of this Website, including
		all uploaded files, layout design, data, graphics, articles, file content, codes, news,
		tutorials, videos, reviews, forum posts and databases contained on the Website or in connection
		with the Services. You must not use or replicate our copyright material other than as permitted
		by law. Specifically, you must not use or replicate our copyright material for commercial
		purposes unless expressly agreed to by Us, in which case we may require you to sign a Licence
		Agreement.
	</p>
	<p class="m-1">
	...
	<p class="m-1">
		...
		Website and the Services associated with this Website, you are agreeing to the Privacy Policy.
	...
	<p class="m-1 mb-3">
		...
		having jurisdiction in New South Wales. We retain the right to bring proceedings against you for
		breach of these Terms and Conditions, in your country of residence or any other appropriate
