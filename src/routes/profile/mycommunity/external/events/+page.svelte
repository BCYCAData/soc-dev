<script lang="ts">
	...
	if (data?.profileMyCommunityExternalEventsFormData) {
		communityMeetingChoices =
			data.profileMyCommunityExternalEventsFormData.community_meeting_choices;
		otherCommunityMeeting = data.profileMyCommunityExternalEventsFormData.other_community_meeting;
