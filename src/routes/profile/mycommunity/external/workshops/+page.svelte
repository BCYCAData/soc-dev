<script lang="ts">
	...
	if (data?.profileMyCommunityExternalWorkshopsFormData) {
		communityWorkshopChoices =
			data.profileMyCommunityExternalWorkshopsFormData.community_workshop_choices;
		otherCommunityWorkshop =
			data.profileMyCommunityExternalWorkshopsFormData.other_community_workshop;
		willRunCommunityWorkshops =
			data.profileMyCommunityExternalWorkshopsFormData.will_run_community_workshops;
...
>
	...
	<input
		...
		value={communityExternalProfileId}
		hidden
	/>
