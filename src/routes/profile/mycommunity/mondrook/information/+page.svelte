<script lang="ts">
	...
	if (data?.profileMyCommunityMondrookInformationFormData) {
		informationSheetChoices =
			data.profileMyCommunityMondrookInformationFormData.information_sheet_choices;
		otherInformationSheet =
			data.profileMyCommunityMondrookInformationFormData.other_information_sheet;
