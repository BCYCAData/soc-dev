...
export const soc_theme: CustomThemeConfig = {
	...
	properties: {
		...
		'--theme-font-family-base':
			"'Inter', 'Poppins', 'system-ui', 'ui-sans-serif', '-apple-system', 'BlinkMacSystemFont', 'Segoe UI', 'Helvetica Neue', 'Arial', 'NotoSans', 'sans-serif', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji', 'Arial'",
