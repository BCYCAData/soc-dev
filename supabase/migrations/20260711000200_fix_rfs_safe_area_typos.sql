-- Cosmetic fix in the RFS street report (get_rfs_property_data_for_street):
-- two safe_area availability strings read "for a short period in /nan
-- emergency." — a mangled newline escape. They now read "in an emergency.",
-- matching the wording of every other availability branch. The function body
-- is otherwise identical to 20260711000100_fix_rfs_report_equipment_column.sql.
-- (The property report function never had the typo.)
